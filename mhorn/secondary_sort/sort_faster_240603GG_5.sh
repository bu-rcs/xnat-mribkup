...
logfile="runlog-v2-240603GG.MR.INVESTIGATORS_S.5-${rundate}.log"
...
find /cnc/DATA/tmp -type f -name "*240603GG.MR.INVESTIGATORS_S.5*.dcm" -print0 | tac -s '' | sort -z | while IFS= read -r -d '' path; do
    echo "Starting ..."
    echo "$path"
