...
# partition at /cnc/DATA/tmp into organized INVESTIGATOR
# Directories in /cnc/DATA/INVESTIGATORS
...
export RUGPNAS_TMP_DIR=/cnc/DATA/tmp
...
#then 
#	echo "Archiving..." 
#	find $RUGPNAS_DATA_DIR/INVESTIGATORS -maxdepth 2 -mindepth 2 -mtime +30 ! -name "*.tar.gz" -exec tar cfzv --remove-files {}.tar.gz {} \;
#else
#	echo "Archive up to date!"
#fi
#
# Moved this functionality to 'maketar' script written by T. Kohl - 3/19/21
#
echo "Finished."
echo "Exiting..."
echo "Invoking maketar script."
exec /cnc/scripts/maketar
